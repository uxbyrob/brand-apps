...
(function($) {
    ...
    bootstrapSelect.prototype = {
        init: function() {
            ...
            _self.generatedSelect.find('.input-group-btn').append('<button tabindex="-1" type="button" class="btn ' + _self.settings['button-style'] + ' dropdown-toggle"><span class="ihs-icon-chevron"></span></button>');
            _self.generatedSelect.find('.input-group-btn').append('<ul tabindex="-1" class="dropdown-menu ' + _self.settings['button-style'].replace('btn-', '') + '"></ul>');
